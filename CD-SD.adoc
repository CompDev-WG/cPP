= Supporting Document Mandatory Technical Document: Evaluation Activities for collaborative PP-Module for Companion Devices
:showtitle:
:toc: macro
:toclevels: 7
:sectnumlevels: 7
...
:pp-name: Protection Profile for Mobile Device Fundamentals
:pp-version: Version 4.0
:pp-date: TBD
...
This Supporting Document has been developed by the {iTC-longname} iTC and is designed to be used to support the evaluations of TOEs against the PP-Module identified in <<Technology Area and Scope of Supporting Document>>.
